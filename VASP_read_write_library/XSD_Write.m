...
% Bonding = docNode.createElement('Bonding');
% Bonding.setAttribute('ID',num2str(NAtoms+9));
% Bonding.setAttribute('IsBondingMonitored','1');
% Bonding.setAttribute('IsHBondingMonitored','0');
% Bonding.setAttribute('IsCloseContactMonitored','0');
% AtomisticTreeRootElement.appendChild(Bonding);
